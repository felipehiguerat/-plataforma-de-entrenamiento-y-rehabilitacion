...
class ExerciseSession(Base):
    ...
    day = Column(DateTime, default=datetime.utcnow)  # Día de la sesión
...
class Exercise(Base):
    ...
    session_id = Column(UUID(as_uuid=True), ForeignKey("exercise_sessions.session_id"), nullable=False)
